...
//            if (matcher.find()) {
//                int year = NumberUtil.toInt(matcher.group(1));
//                int month = NumberUtil.toInt(matcher.group(3));
//                int day = NumberUtil.toInt(matcher.group(5));
...
//    }
    ...
    public static boolean isChinese(String value) {
        return isMactchRegex("^" + PatternPool.RE_CHINESE + "+$", value);
    }
