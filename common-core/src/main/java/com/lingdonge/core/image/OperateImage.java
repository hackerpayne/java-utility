//package com.kyle.image;
//
//import com.kyle.token.StringUtils;
...
//     * @throws IOException
//     */
//    public void cropImage(String srcPath, String toPath, int x, int y, int width, int height, String readImageFormat, String writeImageFormat) throws IOException {
...
//     * @param alpha        透明度（0<alpha<1）1不透明
//     * @param font         字体（例如：宋体）
...
//    /**
//     * 以指定的质量保存Jpg
//     * 为了图片质量，quality的值不能太低。
//     *
//     * @param image
//     * @param filePath
//     * @param quality  JPG质量，0.0到1.0之间
//     * @throws Exception
//     */
//    public static void saveImageUsingJPGWithQuality(BufferedImage image, String filePath, float quality) throws Exception {
//
...
//
//        ImageWriter imageWriter = iter.next();//得到Writer
//
//        // 得到指定writer的输出参数设置(ImageWriteParam )
//        ImageWriteParam iwp = imageWriter.getDefaultWriteParam();
//        iwp.setCompressionMode(ImageWriteParam.MODE_EXPLICIT);// 设置是否可压缩
...
//     * @param filePath
//     */
//    public static void savePngImage(BufferedImage image, String filePath) {
...
//     * @param savePath
//     */
//    public static void generatePicture(String templateFile, String title, String position, String page, String description, String tips, String savePath) {
//
//        FileOutputStream fos = null;
//        try {
//            BufferedImage image = ImageIO.read(new File(templateFile));
//
//
//            //创建java2D对象
//            Graphics2D g2d = image.createGraphics();
...
//
//            //设置文字字体名称、样式、大小
////            g2d.setFont(new Font("LucidaSansRegular", Font.PLAIN, 18));
////            g2d.setColor(Color.black);//设置字体颜色
//
//            // 往坐标下面写内容
//
//            //标题
//            g2d.setFont(new Font("PingFang SC", Font.PLAIN, 36));
//            g2d.setColor(Color.decode("#202026"));//设置字体颜色
//            String[] splitLines = StringUtils.split(title, 19);
//
//            if (splitLines.length == 1) {//只有一行标题的， 位置需要继续微调
//                g2d.drawString(splitLines[0], 60, 250); //输入水印文字及其起始x、y坐标
//            } else {
//                for (Integer line = 0; line < splitLines.length; line++) {
//                    switch (line) {
//                        case 0:// 第一行写在什么位置
//                            g2d.drawString(splitLines[line], 60, 230); //输入水印文字及其起始x、y坐标
//                            break;
//                        case 1:// 第二行写在什么位置
//                            g2d.drawString(splitLines[line], 60, 275); //输入水印文字及其起始x、y坐标
//                            break;
//                    }
//                }
//            }
//
//            //排名
//            g2d.setFont(new Font("PingFang SC", Font.PLAIN, 24));
//            g2d.setColor(Color.decode("#ffffff"));//设置字体颜色
//
//            if (position.length() > 1)//超出2位数，需要微调界面
//                g2d.drawString(position, 306, 370);
//            else
//                g2d.drawString(position, 315, 370);
//
//            //所在页数
//            g2d.setFont(new Font("PingFang SC", Font.PLAIN, 28));
//            g2d.setColor(Color.decode("#ff5300"));//设置字体颜色
//            g2d.drawString(page, 304, 454);
//
//            //相关描述
//            g2d.setFont(new Font("PingFang SC", Font.PLAIN, 26));
//            g2d.setColor(Color.decode("#414049"));//设置字体颜色
//            splitLines = StringUtils.split(description, 24);
//            for (Integer line = 0; line < splitLines.length; line++) {
//                switch (line) {
//                    case 0:// 第一行写在什么位置
//                        g2d.drawString(splitLines[line], 60, 600); //输入水印文字及其起始x、y坐标
//                        break;
//                    case 1:// 第二行写在什么位置
//                        g2d.drawString(splitLines[line], 60, 640); //输入水印文字及其起始x、y坐标
//                        break;
//                    case 3:// 第三行写在什么位置
//                        g2d.drawString(splitLines[line], 60, 680); //输入水印文字及其起始x、y坐标
//                        break;
//                    case 4:// 第四行写在什么位置
//                        g2d.drawString(splitLines[line], 60, 720); //输入水印文字及其起始x、y坐标
//                        break;
//                    case 5:// 第五行写在什么位置
//                        g2d.drawString(splitLines[line], 60, 760); //输入水印文字及其起始x、y坐标
//                        break;
//                }
//            }
//
//            // 点赞评语
//            g2d.setFont(new Font("PingFang SC", Font.PLAIN, 30));
//            g2d.setColor(Color.decode("#0086FD"));//设置字体颜色
//            splitLines = StringUtils.split(tips, 17);
//
//            if (splitLines.length == 1) {
//                g2d.drawString(splitLines[0], 156, 840); //输入水印文字及其起始x、y坐标
//            } else {
//                for (Integer line = 0; line < splitLines.length; line++) {
//                    switch (line) {
//                        case 0:// 第一行写在什么位置
//                            g2d.drawString(splitLines[line], 156, 830); //输入水印文字及其起始x、y坐标
//                            break;
//                        case 1:// 第二行写在什么位置
//                            g2d.drawString(splitLines[line], 156, 870); //输入水印文字及其起始x、y坐标
//                            break;
//                        case 3:// 第三行写在什么位置
//                            g2d.drawString(splitLines[line], 156, 910); //输入水印文字及其起始x、y坐标
//                            break;
//                    }
//                }
//            }
...
//
//            // 使用Jpg高质量导出
////            saveImageUsingJPGWithQuality(image, savePath, 0.5f);
//        } catch (Exception e) {
//            e.printStackTrace();
//        } finally {
//            if (fos != null) {
...
//
//        for (int i = 1; i < 39; i++) {
//            String page = String.valueOf((int) Math.floor((i - 1 + 10) / 10));
//            System.out.println(StringUtils.format("数据排位为：【{}】在第【{}】页", i, page));
//        }
//
//        // 打印所有字体
...
////        imageObj.alphaWords2Image(imgPath, 1, "LucidaSansRegular", Font.PLAIN, 14, Color.BLACK, "我来测试 This is a multithreading", 100, 100, "png", savePath);
//
//        String imgPath = "/Users/kyle/Downloads/template.jpg";
//        String savePath = "/Users/kyle/Downloads/template_result.jpg";
//
//        String title = "SEO每天一贴-网站优化排名技术博客SEO每天一贴-网站优化排名技术博客";
//        String position = "22";
//        String page = "2";
//        String description = "这里写描述相关的内容这里写描述相关的内容这里写描述相关的内容这里写描述相关的内容这里写描述相关的内容";
//        String tips = "这里写描述相关的内容这里写描述相关的内容这里写描述相关的内容";
//
//        generatePicture(imgPath, title, position, page, description, tips, savePath);
//
//        savePath = "/Users/kyle/Downloads/template_result_2.jpg";
//        title = "网站优化排名技术博客";
//        position = "1";
//        page = "2";
//        description = "这里写描述相关的内容";
//        tips = "这里写描述相关的内容";
//        generatePicture(imgPath, title, position, page, description, tips, savePath);
//
//        System.out.println("添加完成");
//
//        /*String srcPath = "D:/multithreading/fileSource/004.jpg";
//     String toPath = "D:/multithreading/desk/+e004.jpg";
//     int x = 200;
//     int y = 300;
//     int width = 300;
//     int height = 200 ;
...
//       /* String negativeImagePath = "D:/multithreading/fileSource/004.jpg";
//        String additionImagePath = "D:/multithreading/fileSource/005.jpg";
//        int x = 200;
//        int y = 200;
//        String toPath = "D:/multithreading/desk/004+005-rightcenter.jpg";*/
...
//
//     /*
//     String srcImage = "D:/multithreading/fileSource/001.jpg";
//     String toPath = "D:/multithreading/desk/001-gray.jpg";
//     String imageFormat = "jpg";
//     imageObj.grayImage(srcImage, toPath, imageFormat);//图片灰化
//      */
//
//     /*
//     String firstSrcImagePath = "D:/multithreading/desk/003.jpg";
//     String secondSrcImagePath = "D:/multithreading/desk/004.jpg";
//     String imageFormat = "jpg";
//     String toPath = "D:/multithreading/desk/003-004-join.jpg";
//     imageObj.joinImagesHorizontal(firstSrcImagePath, secondSrcImagePath, imageFormat, toPath);//横向拼接图片
//     */
//
//     /*
//     String firstSrcImagePath = "D:/multithreading/desk/001-002-join.jpg";
//     String secondSrcImagePath = "D:/multithreading/desk/003-004-join.jpg";
//     String imageFormat = "jpg";
//     String toPath = "D:/multithreading/desk/all-join.jpg";
//     imageObj.joinImagesVertical(firstSrcImagePath, secondSrcImagePath, imageFormat, toPath);//纵向拼接图片
//     */
//
//     /*String srcImagePath = "D:/multithreading/fileSource/002.jpg";
//     int[] xPoints = {20,100,160,270,500};
//     int[] yPoints = {30,150,172,295,615};
//     int nPoints = 5;
//     String toPath = "D:/multithreading/desk/polygon-002.png";
//     imageObj.drawPolygon(srcImagePath, xPoints, yPoints, nPoints, Color.MAGENTA, "jpg", toPath); //根据坐标数组绘制多边形
//     */
//
//     /*String srcImagePath = "D:/multithreading/fileSource/004.jpg";
//     String appendImagePath = "D:/multithreading/fileSource/005.jpg";
//     float alpha = 0.2F;
//     String  font = "宋体";
...
//     int y = 40;
//     String imageFormat = "jpg";
//     String toPath = "D:/multithreading/desk/alphaI2I-001.png";*/
...
//
//     /*
//     String srcImagePath = "D:/multithreading/fileSource/003.jpg";
//     int[] xPoints = {100,150,200,240,300};
//     int[] yPoints = {200,60,280,160,100};
//     int nPoints = 5;
//     Color lineColor = Color.RED;
//     String toPath = "D:/multithreading/desk/polyline-003.jpg";
//     String imageFormat = "jpg";
...
//     String imageFormat = "jpg";
//     String toPath = "D:/multithreading/desk/point-002.jpg";
...
//     Color ovalColor = Color.RED;
//     String imageFormat = "jpg";
//     String toPath = "D:/multithreading/desk/points-004.jpg";
...
//     String srcImagePath = "D:/multithreading/fileSource/003.jpg";
//     String toPath = "D:/multithreading/desk/showpoints-003.jpg";
...
//     String imageFormat ="jpg";
//     String toPath ="D:/multithreading/desk/drawalpha-004.jpg";
//     imageObj.drawAndAlphaPolygon(srcImagePath, xPoints, yPoints, nPoints, polygonColor, alpha, imageFormat, toPath);
//     */
//     /*
//     String negativeImagePath = "D:/multithreading/fileSource/001.jpg";
//     String additionImagePath = "D:/multithreading/fileSource/006.png";
//     String  toPath = "D:/multithreading/fileSource/001.jpg";
...
//     /*String negativeImagePath = "D:/multithreading/fileSource/001.jpg";
//     String  toPath = "D:/multithreading/fileSource/001.jpg";
//     String additionImagePath = "D:/multithreading/fileSource/007.png";
...
//
//     /*List iamgePathList = new ArrayList();  // D:/multithreading/16a/
//     iamgePathList.add("D:/multithreading/16a/12384_2492.jpg");
//     iamgePathList.add("D:/multithreading/16a/12384_2493.jpg");
//     iamgePathList.add("D:/multithreading/16a/12384_2494.jpg");
//     iamgePathList.add("D:/multithreading/16a/12384_2495.jpg");
//     iamgePathList.add("D:/multithreading/16a/12384_2496.jpg");
//     iamgePathList.add("D:/multithreading/16a/12384_2497.jpg");
//     iamgePathList.add("D:/multithreading/16a/12384_2498.jpg");
//     iamgePathList.add("D:/multithreading/16a/12384_2499.jpg");
//     iamgePathList.add("D:/multithreading/16a/12384_2500.jpg");
//     iamgePathList.add("D:/multithreading/16a/12384_2501.jpg");
//     iamgePathList.add("D:/multithreading/16a/12384_2502.jpg");*/
//        //String imageFormat = "jpg";
//        //String toPath = "D:/multithreading/desk/16a_v1.jpg";
//        //imageObj.joinImageListHorizontal(iamgePathList, imageFormat, toPath);
//
//     /*String imageFormat = "jpg";
//     String[] pics1 = {"D:/multithreading/16a/12384_2502.jpg","D:/multithreading/16a/12384_2501.jpg",
//       "D:/multithreading/16a/12384_2500.jpg","D:/multithreading/16a/12384_2499.jpg","D:/multithreading/16a/12384_2498.jpg",
//       "D:/multithreading/16a/12384_2497.jpg","D:/multithreading/16a/12384_2496.jpg","D:/multithreading/16a/12384_2495.jpg",
