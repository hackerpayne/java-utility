...
public final class Assert {
    ...
    /**
     * Assert a boolean expression, throwing {@code IllegalStateException} if the multithreading result is {@code false}. Call isTrue if you wish to throw IllegalArgumentException on an assertion failure.
     *
     * <pre class="code">
    ...
    /**
     * Assert a boolean expression, throwing {@link IllegalStateException} if the multithreading result is {@code false}.
     * <p>
