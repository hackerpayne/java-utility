package com.lindonge.core.thirdparty.qrcode;
...
public class QRCodeUtil {
     ...
     * @param outputFile 保存位置
     * @return 生成的二维码图片路径
     * @throws Exception
     */
    public static String generateQRCode(String text, int width, int height, String format, File outputFile) throws Exception {
