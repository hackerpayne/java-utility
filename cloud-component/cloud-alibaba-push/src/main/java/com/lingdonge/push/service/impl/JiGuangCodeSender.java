...
public class JiGuangCodeSender implements PushCodeSender {
    ...
    @Override
    public PushSendResult messagePush(PushSenderAccount pushSenderAccount, String alias, String notificationTitle,
    ...
    public Map<String, String> sendToAliasList(List<String> alias, String notificationTitle, String msgTitle,
                                               String msgContent, String extras, Integer deviceType, PushSenderAccount pushSenderAccount) {
        PushPayload pushPayload = null;
        if (deviceType == 0) {// ios
            pushPayload = buildPushObject_ios_aliasList_alertWithTitle(alias, notificationTitle, msgTitle, msgContent,
                    extras, pushSenderAccount.getApnsProduction());
    ...
    public void sendToTagsList(List<String> tagsList, String notificationTitle, String msgTitle, String msgContent,
        ...
        PushPayload pushPayload = buildPushObject_all_tagList_alertWithTitle(tagsList, notificationTitle, msgTitle,
                msgContent, extras, apnsProduction);
    ...
    private PushResult sendPush(PushPayload pushPayload, Integer deviceType, PushSenderAccount pushSenderAccount) {
        log.info("pushPayload={}", pushPayload);
        PushResult pushResult = null;
        JPushClient jPushClient = null;
        try {
            if (deviceType == 0) {// ios
                jPushClient = new JPushClient(pushSenderAccount.getJPushIosMasterSecret(),
                        pushSenderAccount.getJPushIosAppKey());
            } else if (deviceType == 1) {// android
                jPushClient = new JPushClient(pushSenderAccount.getJPushAndroidMasterSecret(),
                        pushSenderAccount.getJPushAndroidAppKey());
            }
