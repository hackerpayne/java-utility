...
import com.lingdonge.http.webmagic.model.HttpRequestBody;
import com.lingdonge.http.webmagic.utils.Experimental;
...
public class Request implements Serializable {
    ...
    /**
     * 增加StringEntity传参。以支持Raw类型的数据post
     */
     ...
     * @param pageType
     */
    public Request(String url, String pageType) {
        this.url = url;
        this.putExtra(PageType.PAGE_TYPE, pageType);
    }
