package com.lingdonge.spider.webmagic.xsoup.w3c;
...
//        assertThat(getNodeValue(document, "//a[@id]")).isNull();
        ...
        //TODO: illegal
        //assertThat(getNodeValue(document,"//div[@id=multithreading]")).isEqualTo(expectedDiv);
...
//        assertThat(getNodeValue(document, "//*[@id='te' or @id='multithreading']")).isEqualTo(expectedDiv);
//
//        assertThat(getNodeValue(document, "//*[@id='te' and @id='multithreading']")).isNullOrEmpty();
//
//        assertThat(getNodeValue(document, "//*[@id='te' and @id='multithreading']")).isNullOrEmpty();
//
//        assertThat(getNodeValue(document,"//*[(@id='te' or @id='multithreading') and @id='multithreading']")).isEqualTo(expectedDiv);
//
//        assertThat(getNodeValue(document,"//*[@id='te' or (@id='multithreading' and @id='id')]")).isNull();
    }
...
//        assertThat(getNodeValue(document,"//div[contains(@id,'te')]")).isEqualTo("<div id=\"multithreading\">\n" +
//                " aaa\n" +
//                " <div>\n" +
//                "  <a href=\"https://github.com\">github.com</a>\n" +
//                " </div>\n" +
//                "</div>");
    ...
    public void testCombingXPath() throws XPathExpressionException {
        ...
        String expectedDiv1 = "<div id=\"multithreading\">\n" +
                " aaa\n" +
                " <div>\n" +
                "  <a href=\"https://github.com\">github.com</a>\n" +
                " </div>\n" +
...
//        assertThat(getNodeValue(document, "//div[@id='multithreading'] | //div[@id='test2']")).isEqualTo(expectedDiv1);
