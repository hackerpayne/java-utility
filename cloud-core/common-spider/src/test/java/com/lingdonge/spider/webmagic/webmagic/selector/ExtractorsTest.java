...
public class ExtractorsTest {
    ...
    String html = "<div><h1>multithreading<a href=\"xxx\">aabbcc</a></h1></div>";
...
//        assertThat(jsoupxpath("//a/@href").select(html)).isEqualTo("xxx");
...
//        OrSelector or = or($("div h1 a", "innerHtml"), jsoupxpath("//title"));
