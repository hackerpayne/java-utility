package com.lingdonge.spider.webmagic.xsoup;

import com.lingdonge.spider.xsoup.XElements;
import com.lingdonge.spider.xsoup.XPathEvaluator;
import com.lingdonge.spider.xsoup.Xsoup;
import com.lingdonge.spider.xsoup.xevaluator.XPathParser;
...
//        assertThat(result).isNull();
        ...
        result = Xsoup.select(document, "//div[@id=multithreading]").get();
        String expectedDiv = "<div id=\"multithreading\">\n" +
                " aaa\n" +
                " <div>\n" +
...
//        String result = Xsoup.select(document, "//*[@id=te or @id=multithreading]/text()").get();
//        assertThat(result).isEqualTo("aaa");
//
//        result = Xsoup.select(document, "//*[@id=multithreading or @id=te]/text()").get();
//        assertThat(result).isEqualTo("aaa");
//
//        result = Xsoup.select(document, "//*[@id=te and @id=multithreading]/text()").get();
//        assertThat(result).isNull();
//
//        result = Xsoup.select(document, "//*[(@id=te or @id=multithreading) and @id=multithreading]/text()").get();
//        assertThat(result).isEqualTo("aaa");
//
//        result = Xsoup.select(document, "//*[@id=te or (@id=multithreading and @id=id)]/text()").get();
//        assertThat(result).isNull();
    }
...
//        assertThat(result).isEqualTo("<div id=\"multithreading\">\n" +
//                " aaa\n" +
//                " <div>\n" +
//                "  <a href=\"https://github.com\">github.com</a>\n" +
//                " </div>\n" +
//                "</div>");
    ...
    public void testCombingXPath() {
        ...
        XPathEvaluator xPathEvaluator = XPathParser.parse("//div[@id='multithreading']/text() | //div[@id='test2']/text()");
//        assertThat(xPathEvaluator.hasAttribute()).isTrue();
//        XElements select = xPathEvaluator.evaluate(document);
//        assertThat(select.get()).isEqualTo("aaa");
//
//
//        select = Xsoup.select(html2, "//div[@id='multithreading']/text() | //div[@id='test2']/text()");
//        assertThat(select.get()).isEqualTo("aa");
//
//        select = Xsoup.select(html + html2, "//div[@id='multithreading']/text() | //div[@id='test2']/text()");
//        assertThat(select.list()).contains("aaa", "aa");
//
//        xPathEvaluator = XPathParser.parse("//div[@id='multithreading'] | //div[@id='test2']");
//        assertThat(xPathEvaluator.hasAttribute()).isFalse();
    }
