...
public class HttpUriRequestConverter {
     ...
     * @return
     */
    public HttpClientRequestContext convert(HttpRequest request, HttpSetting site, ModelProxy proxy) {
     ...
     * @return
     */
    private HttpClientContext convertHttpClientContext(HttpRequest request, HttpSetting site, ModelProxy proxy) {
     ...
     * @return
     */
    private HttpUriRequest convertHttpUriRequest(HttpRequest request, HttpSetting site, ModelProxy proxy) {
