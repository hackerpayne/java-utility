...
public class HttpUriRequestConverter {
     ...
     * @return
     */
    public HttpClientRequestContext convert(Request request, Site site, ModelProxy proxy) {
     ...
     * @return
     */
    private HttpClientContext convertHttpClientContext(Request request, Site site, ModelProxy proxy) {
     ...
     * @return
     */
    private HttpUriRequest convertHttpUriRequest(Request request, Site site, ModelProxy proxy) {
        ...
        if (site != null) {
            requestConfigBuilder.setConnectionRequestTimeout(site.getTimeOut())
                    ...
                    .setCookieSpec(CookieSpecs.STANDARD);//设置Cookie处理方法
        }

//        requestConfigBuilder.setCookieSpec("easy");
//        requestConfigBuilder.setCookieSpec(CookieSpecs.IGNORE_COOKIES);//防止Cookie出错，慎用，不知道会出什么异常
    ...
    private RequestBuilder addFormParams(RequestBuilder requestBuilder, Request request) {
        ...
        // 添加StringEntity传参
        if (null != request.getStringEntity()) {
            requestBuilder.setEntity(request.getStringEntity());
        }
